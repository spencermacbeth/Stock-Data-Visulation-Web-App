...
$qryPie = "SELECT date, ".$pie_metric." FROM stock_data WHERE ticker = '".$ticker."' AND ".$pie_metric." != '0.0' ;";
$qryBar = "SELECT date, ".$bar_metric." FROM stock_data WHERE ticker = '".$ticker."' AND ".$bar_metric." != '0.0';";
$qryLine = "SELECT date, ".$line_metric." FROM stock_data WHERE ticker = '".$ticker."' AND ".$line_metric." != '0.0';";
$qryTable = "SELECT ticker, AVG(peg_ratio) as peg_ratio, AVG(price_to_book) as price_to_book, AVG(debt_to_equity) as debt_to_equity "
    . " from stock_data WHERE ticker = '".$ticker."' GROUP BY ticker;";
...
<div class="container">
    ...
    <div class="col-md-12">
        <div class="panel panel-default panel-info">
            <div class="panel-heading"><h3 class="panel title">Average performance of <b><?php echo $ticker ?></b></h3></div>
            <div class="panel-body">
                <div id="table_div" style="width: 100%; height: 10%;"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel title"><h2><b>Preview of <?php echo $ticker ?>'s statistics</b></h2></div>
            <div class="panel-body">
                <p>GRODT currently supports visualizations for what we deem to be the three
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default panel-info">
                <div class="panel-heading"><h3 class="panel title">Histogram of <b><?php echo str_replace("_", " ", $bar_metric);?></b> by <b>year</b> for <?php echo $ticker?> </h3></div>
                <div class="panel-body">
        ...
        <div class="col-md-6">
            <div class="panel panel-default panel-info">
                <div class="panel-heading"><h3 class="panel title">Pie chart of <b><?php echo str_replace("_", " ", $pie_metric);?></b> by <b>year</b> for <?php echo $ticker?></h3></div>
                <div class="panel-body">
        ...
        <div class="col-md-12">
            <div class="panel panel-default panel-info">
                <div class="panel-heading"><h3 class="panel title">Line graph of <b><?php echo str_replace("_", " ", $line_metric);?></b> by <b>year</b> for <?php echo $ticker?></h3></div>
                <div class="panel-body">
